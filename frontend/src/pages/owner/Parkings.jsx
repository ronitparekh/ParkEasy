                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
                    ...
                    <div className="self-start sm:self-auto shrink-0 flex items-center gap-2">
                      <button
                        onClick={() => navigate(`/owner/parkings/${p._id}/analytics`)}
                        className="border border-white/20 rounded-lg p-2 text-gray-200 hover:bg-white/5"
                        title="Analytics"
                      ...
                      <button
                        ...
                        className="border border-white/20 rounded-lg px-3 py-2 text-red-300"
                  ...
                  <div className="mt-auto pt-4 flex flex-col sm:flex-row sm:flex-wrap gap-2 sm:gap-3">
                    <button
                      onClick={() => startEdit(p)}
